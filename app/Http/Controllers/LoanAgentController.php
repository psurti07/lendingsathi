...
class LoanAgentController extends Controller
{
        ...
        try {
            ...
            if ($txStatus == "PAYMENT_SUCCESS") {
                ...
                if ($isEntry == 0) {
                    ...
                    /* send email in brevo */
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment for LendingSathi Hire Agent plan has been successful.', $sendGreetings, 3, $attachments);
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if (isset($responsecode) && $responsecode == 100) {
                    ...
                    $fbdata = array(
                        ...
                        'sourceurl' => 'https://lendingsathi.com/loan-agent/paymentSuccess'
                    );
    ...
    public function getOffer1(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://lendingsathi.com/api/loan-agent/great-deal-offer-response';
        ...
        try {
            ...
            if ($status == 'SUCCESS') {
                ...
                if ($updateCardResponse) {
                    ...
                    if ($regUser) {
                        convertIntoCustomer($cardno, $regUser, $userData, $paymentdata->orderamount ?? 0, $txnId, 1, 'loan-agent', 'LA_', 2);
                    } else {
    ...
    public function getOffer3_cipherpay(Request $request)
    {
        try {
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://lendingsathi.com/api/loan-agent/ultra-saver-offer-response';
        ...
        try {
            ...
            if ($status == 'SUCCESS') {
                ...
                if ($updateCardResponse) {
                    ...
                    if ($regUser) {
                        convertIntoCustomer($cardno, $regUser, $userData, $paymentdata->orderamount ?? 0, $txnId, 1, 'loan-agent', 'LA_', 8);
                    } else {
                        sendPaymentGreetings($userData->first_name . ' ' . $userData->last_name, $userData->mobile, $userData->emailid);
                    }
                }
    ...
    public function getOffer5(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://lendingsathi.com/api/loan-agent/big-benefit-offer-response';
