...
class LegalController extends Controller
{
    public function privacyPolicy()
    {
        ...
        $subTitle = 'Your Privacy Matters — Learn How We Collect, Protect, and Handle Your Information Securely.';
    ...
    public function termsConditions()
    {
        ...
        $subTitle = 'Understanding the terms that help ensure a secure and transparent experience for every user.';
    ...
    public function refundPolicy()
    {
        ...
        $subTitle = 'Transparent guidelines for cancellations, refunds, and customer support assistance.';
