        ...
        foreach ($banks as $bank) {
            $data['list'] .= '<div class="col company" data-index="' . $loop . '">
                            <a href="javascript:;" class="in_tool it-1 r-10">
                                <div class="bg--white-100 block-shadow r-10 mb-20 fbox-7">
                                    <img class="img-fluid" src="https://manage.lendingsathi.com/upload/banks/' . $bank->bank_image . '" alt="' . $bank->bank_name . '" width="auto">
                                </div>
                                <h6 class="s-14 w-700">' . $bank->bank_name . '</h6>
                            </a>
                        </div>';

            $data['carousel'] .= '<div class="bg--white-100 r-10 mb-0 fbox-7 p-2">
                                    <a href="javascript:;">
                                        <img class="img-fluid" src="https://manage.lendingsathi.com/upload/banks/' . $bank->bank_image . '" alt="' . $bank->bank_name . '" width="auto">
                                    </a>
                                </div>';
            ...
            <ul class="accordion">
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I paid, but the account has not been created; what should I do now? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                If the payment gateway holds your funds and has yet to credit the company account, dont worry; once the funds are credited to the company account, your account will be created and you will be notified via email. Otherwise, the payment gateway will refund your funds according to its policies.</p>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I still have not received my refund after so many days; what should I do?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    This could happen if the bank/payment gateway holds your funds. It will be refunded in accordance with the bank/payment gateway rules and regulations.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">Can I get a refund if I misunderstood the company service and/or paid by mistake?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">Despite receiving pre-approved loan offers based on my eligibility, I did not receive an actual loan. Why? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    To understand what a pre-approved loan offer is, please read the terms and conditions carefully.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">Who is eligible for a GST return?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    Anyone who updates their GST information on the portal will receive a GST return. 
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">I changed my mind and no longer want to use the company services; can I receive a refund? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                   The subscription plan payment is only refundable in accordance with the company cancellation and refund policy. For more information
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">What do I do if I am dissatisfied with the company service? </h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">What happens if I make multiple payments by mistake? Am I eligible for a refund?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                   If a customer makes multiple payments, they are eligible for a refund. You can request a refund within 48 hours of making the payment using the website Raising A Request section or calling the company registered contact number.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="accordion-item">
                    <div class="accordion-thumb">
                        <h6 class="s-16 w-500 mb-0">Can I receive a refund if I purchase subscriptions or memberships from multiple companies in your group?</h6>
                    </div>
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                   If a customer purchased Subscriptions/Memberships from multiple companies in our group, they are eligible for a refund. You can request a refund within 48 hours of payment by visiting the website Raising A Request section or calling the company registered phone number.
                                </p>
                            </div>
                        </div>
                    </div>
...
if (!function_exists('sendPaymentGreetings')) {
    ...
    {
        /*if($mobile != '') {
            $smsmessage = "Dear Customer, Congratulations! Your loan application has been successfully submitted. Our Customer Executive will call you shortly. Thanks, LendingSathi";
            $smsresponse = sendtextSMSobb($mobile, $smsmessage, 'main');
        }*/
        if ($email != '') {
            // Send email
            $subject = "Welcome to LendingSathi";
