...
class DashboardController extends Controller
{
    ...
    public function renewalPlanStore(Request $request){
        try{
            ...
            // $returnUrl = "https://lendingsathi.com/api/customer/plan-upgrade";
        ...
        try{
            ...
            if ($checksum == $recd_checksum) {
                ...
                if ($responseCode == 100) {
                    ...
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Successful Plan Renewal for LendingSathi.', $sendGreetings, 3, $pdf);
