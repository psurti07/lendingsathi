        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-12 m-auto">
                <div class="hero-7-txt">
                    <div class=" text-center">
                        ...
                        <p class="mb-20">Get premier financial consultation and services from industry experts to move forward towards your goals with confidence.</p>
            ...
            <div class="col-md-6 col-lg-6 col-12 m-auto mt-md-5">
                <div class="hero-7-img ps-0 text-center">
                    <img src="{{ asset('front/images/home-img-1.png') }}" alt="lendingsathi" class="img-fluid p-0">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-title mb-40">
                    <h2 class="s-28 mb-5">Why Choose <span class="color--green-500">Lending Sathi</span>
                    </h2>
                    <p class="s-16 color--grey mt-0">Because your dreams deserve expert guidance.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col mb-3">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                ...
                                <p>Take advantage of our enriching collaboration with some of the industry's leading NBFCs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-3">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            <div class="in_tool-logo-wrap">
                                <div class="in_tool-logo ico-60">
                                    <div class="fbox-ico ico-50">
                                        <div class="shape-ico color--theme">
                                            <img class="img-fluid"
                                                src="{{ asset('front/images/Outstanding-Subscription-Benefits.png') }}"
                                                alt="content-image">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="in_tool-txt text-start">
                                ...
                                <p>Sit back and experience premium financial consultation and services – all just a tap away.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-md-0 mb-3">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                ...
                                <p>Get expert guidance to help you make better decisions and move forward with clarity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                ...
                                <p>Decide your own way – apply directly or take support from an expert, whichever suits you.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="statistic-1" class="ct-03 py-0 statistic-section division">
    <div class="container">
        <div class="statistic-5-wrapper bg--green-100 p-md-5 p-4 rounded-4">
            <div class="row row-cols-1 row-cols-md-4">
                <div class="col sec-1">
                    <div id="sb-5-1" class="text-center sb-5-1">
                ...
                <div class="col sec-1">
                    <div id="sb-5-1 mb-0" class="text-center sb-5-1">
                        <div class="statistic-block">
                            <div class="statistic-digit">
                                <h2 class="s-30 w-700 mb-10 ">
        ...
        <div class="row d-flex align-items-center mb-0">
            <div class="col-md-6">
                <div class="img-block left-column mb-0">
                    <img class="img-fluid" src="{{ asset('front/images/home-page-02.png') }}" alt="content-image">
                </div>
            </div>
            <div class="col-md-6">
                <div class="txt-block right-column">
                    <p><span class="section-id s-16">About <span class="color--green-500">Us!</span></span></p>
                    <h2 class="s-28 w-700">Lending Sathi: A Trusted Partner in Your Financial Journey</h2>
                    <p>At Lending Sathi, we believe the right financial partner can make all the difference. As your ideal financial partner, we are committed to helping you find solutions that truly match your needs, without confusion or unnecessary complexity. </p>
                    <p>We collaborate with multiple industry-leading NBFCs, allowing us to provide you with a wide range of financial solutions.</p>
                    <p>Our focus is on keeping things clear and straightforward, so you always know what to expect at every stage. With transparent communication and consistent support, we aim to make your experience smooth and dependable from start to finish. </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-12">
                <div class="section-title mb-40">
                    <h2 class="s-28 mb-5">Empower Your <span class="color--green-500">Financial Aspects Smartly</span></h2>
        ...
        <div class="row align-items-center">
                ...
                <div class="team-member position-relative">
                    <div class="team-member-photo  text-center mb-5">
                        <div class="hover-overlay">
                            <img src="{{ asset('front/images/Quick-Self-Apply.png') }}" alt="feature-image" class="img-fluid">
                    ...
                    <div class="txt-block left-column">
                        ...
                        <p class="mb-3 text-start">
                           Get quick access to a seamless online process, simple login links, and customized offers from our trusted NBFC partners.
                        </p>
                        <a href="{{ route('self.apply.main') }}" class="btn r-04 btn--theme hover--tra-black mt-0">
                            Apply Now
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-6 text-center feature-card-right">
                <div class="team-member position-relative">
                    <div class="team-member-photo  text-center mb-5">
                        <div class="hover-overlay">
                            <img src="{{ asset('front/images/Hire-Loan-Agent.png') }}" alt="feature-image" class="img-fluid">
                            <div class="item-overlay"></div>
                        </div>
                    </div>
                    <div class="txt-block left-column">
                        ...
                        <p class="mb-3 text-start">
                            Allow our seasoned professionals to handle the process for you, so you can proceed with ease and without complications.
                        </p>
                        <a href="{{ route('loan.agent.main') }}" class="btn r-04 btn--theme hover--tra-black mt-0">
                            Apply Now
                        </a>
                    </div>
                </div>
        ...
        <div class="fbox-wrapper text-center">
            <div class="row g-3 row-cols-1 row-cols-md-3 row-cols-lg-3">
                <div class="col d-flex">
                    <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 w-100 h-100">
                        ...
                        <div class="fbox-txt">
                            <p class="mt-0">Begin the process by entering your mobile number, bank-registered name, and other necessary information. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 w-100 h-100">
                        ...
                        <div class="fbox-txt">
                            <p class="mt-0">Our system will determine your eligibility and display pre-approved offers. This is not the final offer.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 w-100 h-100">
                        ...
                        <div class="fbox-txt">
                            <p class="mt-0">To gain access to the pre-approved loan offers displayed, choose the plan that best suits your needs.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 w-100">
                        <div class="fbox-ico ico-40">
                            <div class="shape-ico color--theme">
                        ...
                        <div class="fbox-txt">
                            <p class="mt-0">The NBFC will evaluate your profile and documents in accordance with their procedures and guidelines.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 w-100">
                        ...
                        <div class="fbox-txt">
                            <p class="mt-0">The NBFC will make the final decision regarding approval, sanction, and disbursement based on their policies.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title mb-40">
                    ...
                    <p class="description mt-0 s-16 color--grey">Drop us a message, and our team will get in touch with you shortly!</p>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-md-7 col-12 py-md-0 py-4 order-md-1 order-1 mb-md-0 mb-4">
                <div class="h-100">
