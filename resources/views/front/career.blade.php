            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-12 text-center">
                    <div class=" left-column">
                        ...
                        <h2 class="s-28 mb-5">Let’s Grow Together! </h2>
                        <p class="s-16 color--grey mt-0">Unfortunately, we do not currently have any openings. </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-title mb-40">
                    ...
                    <p class="color--grey">Kindly send your updated CV to: info@lendingsathi.com. We will contact you if your profile matches any of our future requirements</p>
                    @endif
                </div>
            </div>
        </div>
...
<section id="features-11" class="py-80 features-section division">
    <div class="container">
        ...
        <div class="fbox-wrapper">
            <div class="row row-cols-1 row-cols-md-3 rows-2 gx-3">
                <div class="col mb-3">
                    <div class="fbox-8 h-100 mb-0">
