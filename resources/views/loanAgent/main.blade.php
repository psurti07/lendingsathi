    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-title mb-40">
                    <h2 class="s-28 mb-5">Why <span class="color--green-500">LendingSathi</span></h2>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 rows-2">
                    <div class="col mb-3 d-flex">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                <h6 class="s-20 w-700 lh-base">Strategic Lending Network</h6>
                    ...
                    <div class="col mb-3 d-flex">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                <h6 class="s-20 w-700 lh-base">Completely Online Process</h6>
                    ...
                    {{-- <div class="col mb-md-0 mb-3">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                <h6 class="s-20 w-700 lh-base">Self-Apply Feature</h6>
                    ...
                    <div class="col mb-3 d-flex">
                        <div class="in_tool it-3 r-12 fbox-7 fbox--hover bg--white-100 r-12 w-100 h-100 mb-0">
                            ...
                            <div class="in_tool-txt text-start">
                                <h6 class="s-20 w-700 lh-base">Hire Loan Agent</h6>
                                <p>Get guidance with eligibility, documentation and the loan application process. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="form-holder">
                    <div class="contact-form-notice">
                        ...
                        <p class="s-14">
                            <strong>Disclosure : </strong>Loan tenure minimum 6 months & maximum 60 months; Maximum APR: 34% p.a.; processing fee: up to 2%. Representative example: ₹1,00,000 at 11.5% for 60 months with ₹2,000 processing fee — EMI ₹2,301, total interest ₹38,059, total repayment ₹1,38,059, indicative APR 14.41%.
                        </p>
                        <p class="s-14">
