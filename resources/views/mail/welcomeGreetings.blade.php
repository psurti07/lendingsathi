    ...
    <body>
        <div class="es-wrapper-color" style="background-color: #f9f9f9;">
            <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="
                ...
                background-image: url(https://lendingsathi.com/assets/images/mail-bgm.png);
                background-color: #f9f9f9;
                " background="https://lendingsathi.com/front/images/bg-01.webp">
                <tbody>
                    <tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <img src="https://lendingsathi.com/public/front/images/logo/logo.png"
                                                                                                alt="LendingSathi"
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            style="padding: 20px; margin: 0; line-height: 2rem;    background-color: #38ba8912;border-top-right-radius:12px;border-top-left-radius:12px;">
                                                                                            <p
                                                                                                style="font-size:2.2rem;color:#38ba89;font-weight:600">
                                                                                                Congratulations! 
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #38ba8912;border: 1px solid #38ba8912;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            style="padding: 0; margin: 0; width: 600px;">
                                                                            <h3 style="text-align:center; color: #38ba89;">
                                                                                Order Details
                                                                            </h3>
                                                                            <hr>
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                width="100%" bgcolor="#ffffff"
                                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #38ba8912; */ background-color: transparent;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #38ba8912; color:#000;font-size:16px; border-radius: 12px;">
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #38ba8912; border-radius:12px;color:#000;font-size:16px">
                                                                                            ...
                                                                                            <a href="https://lendingsathi.com/customer/login"
                                                                                        ...
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <p style="
                                                                                                ...
                                                                                                <a target="_blank"
                                                                                                    ...
                                                                                                    href="https://lendingsathi.com/privacy-policy">
                                                                                                Privacy Policy
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                                    style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                    href="https://lendingsathi.com/terms-and-conditions">
                                                                                                Terms &amp; Conditions
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                                    style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                    href="https://lendingsathi.com/raise-request">
                                                                                                Raise a request
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <p style="
                                                                                                ...
                                                                                                | Email:
                                                                                                <a href="mailto:info@lendingsathi.com"
                                                                                                    style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;">
                                                                                                {{ env('INFO_EMAIL') }}
                                                                                                </a>
                                                                                            </p>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            <a target="_blank"
                                                                                                                href="https://twitter.com/lendingsathi"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                                            <a target="_blank"
                                                                                                                href="https://in.pinterest.com/lendingsathi/"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0; padding-right:10px">
                                                                                                            <a target="_blank"
                                                                                                                href="http://www.youtube.com/@lendingsathi"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0;padding-right:10px">
                                                                                                            <a target="_blank"
                                                                                                                href="https://www.facebook.com/@lendingsathi.in"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0;">
                                                                                                            <a target="_blank"
                                                                                                                href="https://www.instagram.com/lendingsathi/"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
