    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-12 col-lg-6 order-2 order-md-2 order-lg-1">
                    <div class="img-block">
                        <img src="{{ asset('front/images/offer/self-applystandard-offer.jpg') }}" alt="selfapply nbfc list" class="img-fluid rounded-3">
                    </div>
             </div>

            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-1 order-lg-2 mb-lg-0 mb-3">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a> and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of LendingSathi.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="form-holder">
                    <div class="contact-form-notice">
                        ...
                        <p class="s-14">
                            <strong>Important Note:</strong> BE AWARE! We ask our customers to make payments ONLY on our website https://lendingsathi.com and NOT through any other source, directly or indirectly. Thanks!
                        </p>
                    </div>
                </div>
            </div>
