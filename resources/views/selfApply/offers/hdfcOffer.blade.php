                ...
                <div class="row d-flex align-items-bottom">
                    <div class="col-md-12 col-lg-6 order-2 order-md-1">
                        <div class="hero-7-img home-img d-flex justify-content-center align-items-start">
                            <img src="{{ asset('front/images/offer/offerpage.png') }}" alt="LendingSathi" class="img-fluid rounded-3">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6 self-apply-form  form-container order-1 order-md-2 mb-md-0 mb-3">
